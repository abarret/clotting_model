...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        // Wall points
        Pointer<CellVariable<NDIM, double>> w_var = new CellVariable<NDIM, double>("W");
        int w_idx;
        ins_integrator->registerVariable(w_idx, w_var, IntVector<NDIM>(4), ins_integrator->getCurrentContext());
        visit_data_writer->registerPlotQuantity("W", "SCALAR", w_idx);
        ...
        bdry_mesh_mapping->spreadWallSites(w_idx);

#ifndef included_clot_BoundVelocitySource
#define included_clot_BoundVelocitySource
 ...
 */
class BoundVelocitySource : public IBTK::CartGridFunction
{
public:
    /*!
     * \brief Constructor.
     */
    BoundVelocitySource(const std::string& object_name, SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> input_db);
